...
async def sync_document_to_retrieval_stores(
    ...
    *,
    ...
    if chroma_disabled_for_pgvector:
        # pgvector mode: chat's lazy_rag_search reads from rag_published_embeddings
        # via /api/query (pgvector ANN). Chroma is not part of the production stack.
        # This covers both corpus docs and instant-rag uploads.
        result.chroma_status = "skipped"
        result.skipped_reasons.append("VECTOR_STORE=pgvector (Chroma write disabled)")
        logger.info(
