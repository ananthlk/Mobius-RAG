...
async def test_retries_once_on_technical_failure_and_succeeds():
    ...
    async def flaky(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
        call_count["n"] += 1
        if attempt == 0:
...
async def test_gives_up_and_reraises_after_max_retries_exhausted():
    ...
    async def always_fails(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
...
async def test_succeeds_first_try_without_ever_retrying():
    ...
    async def clean(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
        call_count["n"] += 1
        return RetrieverPartialResult(query=query)
...
async def test_each_attempt_passed_the_correct_attempt_number():
    ...
    async def record_attempt(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
...
async def test_retry_of_decision_id_threaded_when_attempt0_persisted_before_dying():
    ...
    async def dies_after_persisting(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
...
async def test_retry_of_decision_id_none_when_failure_precedes_router():
    ...
    async def dies_before_router(db, query, caller_mode=None, attempt=0, retry_of_decision_id=None, token_budget_for_retrieval=None, forced_strategy=None, mode_override=None, force_fanout_queries=None):
        seen_retry_of_decision_ids.append(retry_of_decision_id)
        if attempt == 0:
